...
#if PERF_TIMING
                ExcelDiff.GUI.Timing.Log("GetSheetNames(src)", sw.ElapsedMilliseconds);
#endif
...
#if PERF_TIMING
                ExcelDiff.GUI.Timing.Log("GetSheetNames(dst)", sw.ElapsedMilliseconds);
#endif
